...
class Practica_1_L1A_G06(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Configuration_Usrp")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Configuration_Usrp")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica_1_L1A_G06")
...
def main(top_block_cls=Practica_1_L1A_G06, options=None):
