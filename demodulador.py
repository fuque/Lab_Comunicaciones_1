...
class demodulador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demodulador")
        ...
        self._Ga_win = RangeWidget(self._Ga_range, self.set_Ga, 'Amplitud de audio', "counter_slider", float)
        self.top_grid_layout.addWidget(self._Ga_win)
...
def main(top_block_cls=demodulador, options=None):
