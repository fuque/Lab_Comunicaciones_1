...
class solucion(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "solucion")
        ...
        self.top_grid_layout.addWidget(self._Amplitud_win)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 3628000, Amplitud, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 55000, Amplitud, 0, 0)
...
def main(top_block_cls=solucion, options=None):
